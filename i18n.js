...
const I18N_DICT = {
  es: {
    ...
    'login.modoAdmin': 'Administrador',
    'login.modoVendedor': 'Vendedor',
    ...
    'login.olvideClaveVendedor': 'Pide a tu administrador que la restablezca.',
  ...
  en: {
    ...
    'login.olvideClaveVendedor': 'Ask your admin to reset it.',
